...
public class JasperViewerFX {
    ...
    public JasperViewerFX(Stage owner, String title, String jasper, HashMap params, Connection con){
        ...
        try {            
            ...
            imageHeight = jprint.getPageHeight()+100;
            imageWidth = jprint.getPageWidth()+100;
    ...
    private Scene createScene(){
        ...
        // Menu's buttons
        print = new Button("", new ImageView("/org/fxutils/icons/printer.png"));
        save = new Button("", new ImageView("/org/fxutils/icons/save.png"));
        backPage = new Button("", new ImageView("/org/fxutils/icons/backimg.png"));
        firstPage = new Button("", new ImageView("/org/fxutils/icons/firstimg.png"));
        nextPage = new Button("", new ImageView("/org/fxutils/icons/nextimg.png"));        
        lastPage = new Button("", new ImageView("/org/fxutils/icons/lastimg.png"));
        zoomIn = new Button("", new ImageView("/org/fxutils/icons/zoomin.png"));
        zoomOut = new Button("",new ImageView("/org/fxutils/icons/zoomout.png"));       
